    ...
    <section class="main">
        <div class="sidebar">
            <ul class="sidebar--items">
                ...
                <li>
                    <a href="../bike/productbike.php" id="active--link">
                        <span class="icon icon-2"><i class="ri-product-hunt-line"></i></span>
...
<tbody>
   <?php 
    ...
    $sql = "SELECT * FROM bike_product WHERE STATUS = 'LISTED'";
    ...
    while($row = $result->fetch_assoc()){
        ...
        <td>
            <a class='icon-3' href='bikeedit.php?id=$row[PRODUCT_NO]'>Edit</a>
        </td>
        
        <td>
            <a class='icon-1' href='bikedelete.php?id=$row[PRODUCT_NO]'>Delete</a>
        </td> 
        </tr>
        ";
    }
