    ...
    <section class="main">
        ...
        <ul class="sidebar--items">
            ...
            <ul class="sidebar--bottom-items"  >
                <li >
                    <a href="listed.php" id="active--link">
...
<tbody>
   <?php 
    ...
    $sql = "(SELECT PRODUCT_NO,PRODUCT_NAME,PRODUCT_PRICE,PRODUCT_CONDITION,PRODUCT_DESCRIPTION,PRODUCT_TYPE,PRODUCT_QTY,PRODUCT_DEALMETHOD,MEET_UP,MAILING,PICTURE_ID,SELLER_ID,PROD_ID,STATUS,DATE FROM fashion_product WHERE STATUS = 'PENDING') 
            UNION
            (SELECT PRODUCT_NO,PRODUCT_NAME,PRODUCT_PRICE,PRODUCT_CONDITION,PRODUCT_DESCRIPTION,PRODUCT_TYPE,PRODUCT_QTY,PRODUCT_DEALMETHOD,MEET_UP,MAILING,PICTURE_ID,SELLER_ID,PROD_ID,STATUS,DATE FROM bike_product WHERE STATUS = 'PENDING') ORDER BY 'DATE' DESC;";
